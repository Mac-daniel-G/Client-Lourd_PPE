...
public class Programme {
    ...
    public Programme(int id_programme, String nom_programme, String rythme, String description, String duree, String categorie) {
    ...
    public Programme(String nom_programme, String rythme, String description, String duree, String categorie) {
        this.id_programme = 0;
        this.nom_programme = nom_programme;
        this.rythme = rythme;
        this.description = description;
